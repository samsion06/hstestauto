...
public class MD5Util {
    ...
    这里把它们实现成为static final是表示了只读，能在同一个进程空间内的多个
    Instance间共享*/
...
　　　　　 字节拷贝到output的outpos位置开始
    ...
    */
        ...
        public static void main(String[] args) {
        	//System.out.println(MD5Util.toMD5("12345618920019111_DDAPP_"));
            System.out.println(MD5Util.toMD5("xiaoming").toUpperCase());
